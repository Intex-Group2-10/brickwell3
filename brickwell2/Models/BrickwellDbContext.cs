...
public partial class BrickwellDbContext : DbContext
{
    public BrickwellDbContext()
    {
    }

    public BrickwellDbContext(DbContextOptions<BrickwellDbContext> options)
        : base(options)
    {
    }
    ...
    public virtual DbSet<UserCust> UserCusts { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<FraudPrediction>(entity =>
        {
            ...
            // entity.Property(e => e.CountryOfTransactionUnitedKingdom).HasColumnName("country_of_transaction_United_Kingdom");
            ...
            // entity.Property(e => e.ShippingAddressUnitedKingdom).HasColumnName("shipping_address_United_Kingdom");
        ...
        modelBuilder.Entity<UserCust>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("UserCust");
